  ...
  return (
    ...
    >
      <div className="bg-bgColor p-6 rounded-xl w-full max-w-2xl">
        <h1 className="text-3xl font-poppins mb-6 text-center text-fontColor">Add Artist Information</h1>
          ...
          {artistDetails.map((artist, index) => (
            <div key={index} className="bg-[#FFFDF1] p-6 rounded-lg shadow-md">
              <div className="flex justify-center items-center mb-4">
                ...
                <VerifiedIcon
                  className={`cursor-pointer ${artist.verified ? 'text-blue-500' : 'text-gray-400'}`}
                  onClick={() => handleVerifiedToggle(index)}
                />
              </div>
              <div className="mb-4">
                <label className="block text-sm font-poppins font-bold text-black mb-2">Birth Date</label>
                <input
                  type="date"
              ...
              <div className="mb-4">
                <label className="block text-sm font-poppins font-bold text-black mb-2">Description</label>
                <textarea
